  ...
  state: () => ({
    shoes: [{
      ...
      },
      {
        ...
        sale: true,
        new: false,
        images: ['../assets/photo/id2/1.jpg', '../assets/photo/id2/2.jpg', '../assets/photo/id2/3.jpg', '../assets/photo/id2/4.jpg', ],
        description: 'Cool',
        rate: 0
      },
      {
        ...
        sale: false,
        new: false,
        images: ['../assets/photo/id3/1.jpg', '../assets/photo/id3/2.jpg', '../assets/photo/id3/3.jpg', '../assets/photo/id3/4.jpg', ],
        description: '',
        rate: 5
      },
      {
